...
@section('breadcrumb', 'Company > Devices')
...
<div class="space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Devices</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Hardware connected to your workspace — clock-in terminals and how they sync.
        </p>
    </div>
