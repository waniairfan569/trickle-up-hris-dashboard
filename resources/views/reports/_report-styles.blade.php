<style>
    ...
    * { margin: 0; padding: 0; }
    ...
    /* Header */
    .doc-header { width: 100%; background: #1B2D5E; color: #ffffff; }
    ...
    /* Sections + tables */
    .sec { margin-top: 16pt; }
    .sec-title { font-size: 10pt; font-weight: bold; color: #1B2D5E; border-bottom: 2pt solid #1B2D5E; padding-bottom: 4pt; margin-bottom: 8pt; }
    table.data { width: 100%; border-collapse: collapse; font-size: 8pt; }
    table.data th { background: #1B2D5E; color: #fff; text-align: left; padding: 5pt 6pt; font-size: 7.5pt; }
    table.data td { padding: 4.5pt 6pt; border-bottom: 1pt solid #E5E7EB; }
    table.data tr:nth-child(even) td { background: #F8FAFC; }
    .num { text-align: center; }
    .tot td { font-weight: bold; background: #EEF2FB; border-top: 1.5pt solid #1B2D5E; }
    .st { font-weight: bold; }
    ...
    /* Leave requests */
    .lv-type { font-size: 8.5pt; font-weight: bold; color: #1B2D5E; margin-top: 8pt; }
